...
cp:PutContent("data-asset://text", "blah");
cp:PutContent("data-asset://text-other", "data:text/plain,blahblah");
cp:PutContent("data-asset://text-base64", "data:text/plain;base64,YmxhaGJsYWhibGFo");

print("START PRINT BLOCK");
print(cp:GetContent("data-asset://text"));
print(cp:GetContent("data-asset://text-other"));
print(cp:GetContent("data-asset://text-base64"));
